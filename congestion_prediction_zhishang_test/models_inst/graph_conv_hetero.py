...
class GNN_node_Virtualnode(torch.nn.Module):
    ...
    def forward(self, batched_data):
        ...
        top_embedding = self.virtualnode_embedding_top(torch.zeros(num_top_vn).to(edge_index.dtype).to(edge_index.device))
        ...
        for layer in range(self.num_layer):
            ...
            virtualnode_embedding = virtualnode_embedding + top_embedding[top_batch]
