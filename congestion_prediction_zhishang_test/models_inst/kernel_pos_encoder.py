...
class KernelPENodeEncoder(torch.nn.Module):
    ...
    def __init__(self, kernel_type, cfg, dim_in, dim_emb, expand_x=True):
        super().__init__()
        self.kernel_type = kernel_type
        if self.kernel_type not in ['RWSE', 'HKdiagSE', 'ElstaticSE']:
            raise ValueError("Not supported kernel type.")
