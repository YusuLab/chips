...
def experiment(n, file_name, train_dataset, val_dataset, model, criterion, optimizer, scheduler, device, eval_crs, gb=False):
    loss_train_all = []
    loss_val_all = []
    ...
    for epoch in range(n):
        ...
        with open(file_name, "a", buffering=1) as f:
            f.write(f"{epoch}, {loss_train_tp}, {loss_val_tp}\n")
